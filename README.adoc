...
:uri-demo-playbook: {uri-repo}/blob/master/demo-site.yml
...
Once you've installed Antora and {uri-demo-playbook}[saved the demo playbook] ([.path]_demo-site.yml_) to a local directory, you're ready to {uri-docs-run}[run Antora].
